...
<div style="text-align: center; margin: 2.5em 0;">
  <a href="{{ site.baseurl }}/images/CV.pdf" target="_blank" style="display: inline-block; background-color: #3498db; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; font-weight: 500; font-size: 1.1em;">
    View my CV
  </a>
</div>
...
<div style="max-width: 800px; margin: 0 auto;">
  <div style="border-left: 3px solid #3498db; padding-left: 2em; margin: 2em 0;">
    <h3 style="color: #2c3e50; margin-top: 0;">September 2022</h3>
    <h4 style="color: #34495e; margin: 0.5em 0;">Started Undergraduate Studies</h4>
    <p style="color: #7f8c8d; line-height: 1.6;">Began my studies at Zhejiang University's College of Animal Sciences, immediately drawn to the intersection of biology and technology.</p>
  </div>
...
<div style="background-color: #f8f9fa; border: 1px solid #dee2e6; padding: 2em; margin: 2em 0;">
  <div style="text-align: center; margin-bottom: 1.5em;">
    <strong style="background-color: #3498db; color: white; padding: 0.5em 1em; border-radius: 3px;">May 2023 - Present</strong>
  </div>
...
<div style="background-color: #f8f9fa; border: 1px solid #dee2e6; padding: 2em; margin: 2em 0;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2em;">
    <div style="text-align: center;">
      <h4 style="color: #2c3e50; margin-bottom: 0.5em;">Email</h4>
      <a href="mailto:786967870qq@gmail.com" style="color: #3498db; text-decoration: none; font-weight: 500;">
        786967870qq@gmail.com
      </a>
    </div>
    
    <div style="text-align: center;">
      <h4 style="color: #2c3e50; margin-bottom: 0.5em;">Phone</h4>
      <span style="color: #7f8c8d;">+86 188 5799 3609</span>
    </div>
  </div>
